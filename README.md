...
Sou desenvolvedor apaixonado por tecnologia, aprendizado contínuo e criação de soluções práticas.
Atualmente estou me formando com Sistemas de Inforamação pela Faculdade metropolitana de Manaus, 
desenvolveo projetos, além de atuar em sistemas reais como:

📚 Biblioteca digital (Flask + MySQL + Bootstrap)

🏭 Sistema QRQC com IA, alertas WhatsApp e análise inteligente

🏫 Sistema escolar completo com Flask + SQLite

🌐 Desenvolvimento de sites profissionais com WordPress

Gosto de transformar problemas complexos em aplicações simples, eficientes e bem estruturadas.
...
![DeepLearning](https://img.shields.io/badge/Deeplearning-000?style=for-the-badge&logo=Deepl)
## 🚀 DevOps
...
<center>&copy; 2025 Enzo Jimenez</center>
